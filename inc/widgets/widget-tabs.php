...
/**
 * Adds expopyme_Tabs widget.
 */
add_action( 'widgets_init', create_function( '', 'register_widget( "expopyme_tabs" );' ) );
class expopyme_Tabs extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'ExpoPyme Tabs',
			array(
				'description'	=> __( 'Display a tabbed content widget for your popular posts, recent posts and popular tags.', 'expopyme' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'tabs_post_count' => array (
				'expopyme_widgets_name'				=> 'tabs_post_count',
				'expopyme_widgets_title'			=> __( 'Posts to Show', 'expopyme' ),
				'expopyme_widgets_field_type'		=> 'text'
			),
			'tabs_tag_count' => array (
				'expopyme_widgets_name'				=> 'tabs_tag_count',
				'expopyme_widgets_title'			=> __( 'Tags to Show', 'expopyme' ),
				'expopyme_widgets_field_type'		=> 'text'
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		<ul id="widget-tab" class="clearfix widget-tab-nav">
			<li class="active"><a href="#widget-tab-popular"><?php _e( 'Popular', 'expopyme' ); ?></a></li>
			<li><a href="#widget-tab-latest"><?php _e('Latest', 'expopyme' ); ?></a></li>
			<li><a href="#widget-tab-tags"><?php _e( 'Tags', 'expopyme' ); ?></a></li>
		</ul>
				...
				<?php $popular = new WP_Query('orderby=comment_count&ignore_sticky_posts=1&posts_per_page=' . $tabs_post_count );
					...
					<li class="clearfix">
						...
						<div class="widget-entry-summary">
							...
							<span><?php comments_number( __( 'No Comments', 'expopyme' ), __( '1 Comment', 'expopyme' ), __( '% Comments', 'expopyme' ) ); ?></span>
						</div>
						<?php } else { ?>
