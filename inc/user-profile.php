<?php
add_action('show_user_profile', 'expopyme_extra_profile');
add_action('edit_user_profile', 'expopyme_extra_profile');
add_action('personal_options_update', 'expopyme_save_extra_profile');
add_action('edit_user_profile_update', 'expopyme_save_extra_profile');

function expopyme_save_extra_profile($userID) {
...
function expopyme_extra_profile($user)
{
?>
